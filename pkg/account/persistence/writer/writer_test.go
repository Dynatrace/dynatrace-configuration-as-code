				...
				Groups: map[account.GroupId]account.Group{
					"my-group": {
						...
						Account: &account.Account{
							...
							Policies:    []account.PolicyBinding{{PolicyReference: account.StrReference("Request my Group Stuff")}},
						},
						Environment: []account.Environment{
							{
								...
								Policies: []account.PolicyBinding{
									{PolicyReference: account.StrReference("View environment")},
									{PolicyReference: account.Reference{Id: "my-policy"}},
								},
							},
						},
						...
						Environment: []account.Environment{
							{
								...
								Policies: []account.PolicyBinding{
									{PolicyReference: account.StrReference("View environment")},
									{PolicyReference: account.Reference{Id: "second-policy"}},
								},
							},
							{
								Name:        "myenv123",
								...
								Policies: []account.PolicyBinding{
									{PolicyReference: account.StrReference("View environment")},
									{PolicyReference: account.Reference{Id: "first-policy"}},
								},
							},
						},
						ManagementZone: []account.ManagementZone{
