	...
	assert.Equal(t, map[account.GroupId]account.Group{
		toID("test group"): {
			...
			Account: &account.Account{
				Policies: []account.PolicyBinding{{PolicyReference: account.Reference{Id: toID("account policy")}}},
			},
			Environment: []account.Environment{
				{
					Name:     "abc12345",
					Policies: []account.PolicyBinding{{PolicyReference: account.Reference{Id: toID("environment policy")}}},
				},
			},
		},
