...
import (
	...
	"github.com/dynatrace/dynatrace-configuration-as-code/v2/pkg/config/v2/parameter/environment"
	"github.com/dynatrace/dynatrace-configuration-as-code/v2/pkg/config/v2/parameter/list"
	ref "github.com/dynatrace/dynatrace-configuration-as-code/v2/pkg/config/v2/parameter/reference"
