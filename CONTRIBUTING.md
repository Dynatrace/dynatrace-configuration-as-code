...
Instead of ding A, B happened. This change fixes this behavior by inntroducing C and checking for D.
```
...
To run the unit tests for Monaco, execute the following command in the repository root folder:
```shell
