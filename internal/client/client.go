...
import (
	...
	"github.com/dynatrace/dynatrace-configuration-as-code/internal/rest"
...
//go:generate mockgen -source=client.go -destination=client_mock.go -package=client -imports .=github.com/dynatrace/dynatrace-configuration-as-code/internal/api DynatraceClient
