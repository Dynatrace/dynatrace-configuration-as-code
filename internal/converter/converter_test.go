...
import (
	...
	"github.com/dynatrace/dynatrace-configuration-as-code/internal/config"
	configV1 "github.com/dynatrace/dynatrace-configuration-as-code/internal/config"
	"github.com/dynatrace/dynatrace-configuration-as-code/internal/config/v2/coordinate"
	envParam "github.com/dynatrace/dynatrace-configuration-as-code/internal/config/v2/parameter/environment"
	listParam "github.com/dynatrace/dynatrace-configuration-as-code/internal/config/v2/parameter/list"
	refParam "github.com/dynatrace/dynatrace-configuration-as-code/internal/config/v2/parameter/reference"
	...
	projectV1 "github.com/dynatrace/dynatrace-configuration-as-code/internal/project/v1"
...
func TestLoadPropertiesForEnvironment(t *testing.T) {
	...
	environment := manifest.NewEnvironmentDefinition(environmentName, createSimpleUrlDefinition(), groupName, &manifest.EnvironmentVariableToken{EnvironmentVariableName: "token"})
...
func TestConvertConfigs(t *testing.T) {
	...
	environments := map[string]manifest.EnvironmentDefinition{
		environmentName:  manifest.NewEnvironmentDefinition(environmentName, createSimpleUrlDefinition(), environmentGroup, &manifest.EnvironmentVariableToken{EnvironmentVariableName: "token"}),
		environmentName2: manifest.NewEnvironmentDefinition(environmentName2, createSimpleUrlDefinition(), environmentGroup2, &manifest.EnvironmentVariableToken{EnvironmentVariableName: "token"}),
	}
