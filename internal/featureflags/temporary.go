...
const (
	...
	SkipReadOnlyAccountGroupUpdates FeatureFlagID = "MONACO_SKIP_READ_ONLY_ACCOUNT_GROUP_UPDATES"
	// Documents toggles whether documents are downloaded and / or deployed.
	// Introduced: 2024-04-16; v2.14.0
	Documents FeatureFlagID = "MONACO_FEAT_DOCUMENTS"
	// DeleteDocuments toggles whether documents are deleted
	// Introduced: 2024-04-16; v2.14.2
	DeleteDocuments FeatureFlagID = "MONACO_FEAT_DELETE_DOCUMENTS"
	...
	PersistSettingsOrder FeatureFlagID = "MONACO_FEAT_PERSIST_SETTINGS_ORDER"
	// OpenPipeline toggles whether openpipeline configurations are downloaded and / or deployed.
	// Introduced: 2024-06-10; v2.15.0
	OpenPipeline FeatureFlagID = "MONACO_FEAT_OPENPIPELINE"
	...
	IgnoreSkippedConfigs FeatureFlagID = "MONACO_FEAT_IGNORE_SKIPPED_CONFIGS"
	// Segments toggles whether segment configurations are downloaded and / or deployed.
	// Introduced: v2.18.0
	Segments FeatureFlagID = "MONACO_FEAT_SEGMENTS"
)
...
var Temporary = map[FeatureFlagID]FeatureFlag{
	SkipReadOnlyAccountGroupUpdates: {
		envName:        SkipReadOnlyAccountGroupUpdates,
	...
	DeleteDocuments: {
		envName:        DeleteDocuments,
		defaultEnabled: true,
	},
	PersistSettingsOrder: {
		envName:        PersistSettingsOrder,
		defaultEnabled: true,
	},
	OpenPipeline: {
		envName:        OpenPipeline,
		defaultEnabled: true,
	},
	IgnoreSkippedConfigs: {
		envName:        IgnoreSkippedConfigs,
		defaultEnabled: false,
	},
	Segments: {
		envName:        Segments,
