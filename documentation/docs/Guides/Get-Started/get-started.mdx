...
With Monitoring as Code (MAC) approach, you can manage your Dynatrace environment monitoring tasks with configuration files in preference of using a graphical user interface. This allows you to create, update and manage your monitoring configurations safely, consistently and in a repeatable manner. This can be reused, versioned and shared within a team.
...
In this tutorial, you'll create a tagging rule in an environemnt that will apply tags to hosts and services where Dynatrace server is detected.
